...
--
-- Table structure for table `gallerysections`
--

DROP TABLE IF EXISTS `gallerysections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `gallerysections`
--

LOCK TABLES `gallerysections` WRITE;
/*!40000 ALTER TABLE `gallerysections` DISABLE KEYS */;
INSERT INTO `gallerysections` VALUES (1,1,1,'/public/images/dogimage/finouka1.jpg'),(2,1,2,'/public/images/944830_586112368128673_13451773_n.jpg'),(3,1,3,'/public/images/dogimage/finouka3.jpg'),(4,1,4,'/public/images/dogimage/finouka4.jpg');
/*!40000 ALTER TABLE `gallerysections` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-01-07 18:35:35
