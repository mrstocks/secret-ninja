     <div class="row demo-tiles" style="padding-top: 50px;">
        <div class="col-md-3">
          <div class="tile">
            <img src="/public/images/icons/svg/compas.svg" alt="Compas" class="tile-image big-illustration">
        ...
        <div class="col-md-3">
          <div class="tile">
            <img src="/public/images/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-md-3">
          <div class="tile">
            <img src="/public/images/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-md-3">
          <div class="tile tile-hot">
            <img src="/public/images/icons/svg/chat.svg" alt="Chat" class="tile-image">
