...
if (!isset($_SESSION['logged_in']))  {
	$error = Errors::create(array(
		...
		'info'	=> "Someone tried to login with a index but wasn't authentitacted."
	));
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
							<i class="icon-leaf"></i>
							Feed de Celestia - Admin
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
				<?php include __DIR__ . "/partial/nav-bar-header.php"; ?>
			</div><!-- /.container -->
		</div>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Gallery Admin</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>Admin <small><i class="icon-double-angle-right"></i> The gallery</small></h1>
						</div>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
